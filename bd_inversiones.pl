...
% riesgo medio
inversion("Fondos mutuos",2,500,["largo plazo", "renta variable", "alta liquidez", "mercado de capitales"]).
...
% riesgo alto
inversion("Criptomonedas",3,1000,["plazo variable","renta variable", "derivados", "inversiones especulativas", "alta liquidez", "mercado de capitales"]). % plazo variable segun estrategia que se elija.
inversion("Acciones",3,1500,["largo plazo", "renta variable", "inversiones de crecimiento", "alta liquidez", "mercado de capitales"]).
